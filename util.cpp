...
void DrawString(float x, float y, const string& score, float * color) {
	...
	//GLUT_BITMAP_HELVETICA_10,  GLUT_BITMAP_HELVETICA_12, and GLUT_BITMAP_HELVETICA_18.
	glPushMatrix();
	glLoadIdentity();
...
void DrawStringSmall(float x, float y, const string& score, float * color) {
	//  A pointer to a font style..
	//  Fonts supported by GLUT are:
	// GLUT_BITMAP_8_BY_13, GLUT_BITMAP_9_BY_15,
	// GLUT_BITMAP_TIMES_ROMAN_10,  GLUT_BITMAP_TIMES_ROMAN_24,
...
void DrawStringHead(float x, float y, const string& score, float * color) {
	//  A pointer to a font style..
	//  Fonts supported by GLUT are:
	// GLUT_BITMAP_8_BY_13, GLUT_BITMAP_9_BY_15,
	// GLUT_BITMAP_TIMES_ROMAN_10,  GLUT_BITMAP_TIMES_ROMAN_24,
